...
#─────▀██▀─────
#┊NEZAK ‿ @vzaec
# تم تطوير وبرمجة السورس من قبل علي جاسم
#┊@vzaec ‿ @IEOOOO
#---------------------------------------------------------------------
]]
...
if redis:get(vzaec.."lock_KickBan"..msg.chat_id_) then 
...
else redis:set(vzaec.."lock_KickBan"..msg.chat_id_,true)
...
else redis:set(vzaec.."idphoto"..msg.chat_id_,true)
...
else redis:set(vzaec.."lock_woring"..msg.chat_id_,true)
...
redis:set(vzaec.."lock_id"..msg.chat_id_,true)  
...
else redis:set(vzaec.."welcome:get"..msg.chat_id_,true)  
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(vzaec.."welcome:get"..msg.chat_id_) then 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:mset(
vzaec.."lock_username"..msg.chat_id_,true,
vzaec.."mute_gif"..msg.chat_id_,true,
vzaec.."mute_photo"..msg.chat_id_,true,
vzaec.."mute_audio"..msg.chat_id_,true,
vzaec.."mute_voice"..msg.chat_id_,true,
vzaec.."mute_sticker"..msg.chat_id_,true,
vzaec.."mute_forward"..msg.chat_id_,true,
vzaec.."mute_contact"..msg.chat_id_,true,
vzaec.."mute_location"..msg.chat_id_,true,
vzaec.."mute_document"..msg.chat_id_,true,
vzaec.."lock_link"..msg.chat_id_,true,
vzaec.."lock_tag"..msg.chat_id_,true,
vzaec.."lock_edit"..msg.chat_id_,true,
vzaec.."lock_spam"..msg.chat_id_,true,
vzaec.."lock_bots"..msg.chat_id_,true,
vzaec.."lock_webpage"..msg.chat_id_,true,
vzaec.."mute_video"..msg.chat_id_,true,
vzaec.."mute_inline"..msg.chat_id_,true
)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(
vzaec.."lock_username"..msg.chat_id_,
vzaec.."mute_gif"..msg.chat_id_,
vzaec.."mute_photo"..msg.chat_id_,
vzaec.."mute_audio"..msg.chat_id_,
vzaec.."mute_voice"..msg.chat_id_,
vzaec.."mute_sticker"..msg.chat_id_,
vzaec.."mute_forward"..msg.chat_id_,
vzaec.."mute_contact"..msg.chat_id_,
vzaec.."mute_location"..msg.chat_id_,
vzaec.."mute_document"..msg.chat_id_,
vzaec.."lock_link"..msg.chat_id_,
vzaec.."lock_tag"..msg.chat_id_,
vzaec.."lock_edit"..msg.chat_id_,
vzaec.."lock_spam"..msg.chat_id_,
vzaec.."lock_bots"..msg.chat_id_,
vzaec.."lock_webpage"..msg.chat_id_,
vzaec.."mute_video"..msg.chat_id_,
vzaec..":tqeed_video:"..msg.chat_id_,
vzaec..":tqeed_photo:"..msg.chat_id_,
vzaec..":tqeed_gif:"..msg.chat_id_,
vzaec..":tqeed_fwd:"..msg.chat_id_,
vzaec..":tqeed_link:"..msg.chat_id_,
vzaec.."mute_inline"..msg.chat_id_
)
...
if redis:get(vzaec..":tqeed_photo:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالصور بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(vzaec.."mute_photo"..msg.chat_id_)
redis:set(vzaec..":tqeed_photo:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(vzaec..":tqeed_video:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالفيديو بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(vzaec..":tqeed_video:"..msg.chat_id_)
redis:set(vzaec..":tqeed_video:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(vzaec..":tqeed_video:"..msg.chat_id_) then
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(vzaec..":tqeed_gif:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد الممتحركه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(vzaec.."mute_gif"..msg.chat_id_)
redis:set(vzaec..":tqeed_gif:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(vzaec..":tqeed_fwd:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالتوجيه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(vzaec.."mute_forward"..msg.chat_id_)
redis:set(vzaec..":tqeed_fwd:"..msg.chat_id_,true)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(vzaec.."lock_bots"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." البوتات بالتأكيد تم فتحها \n✓",16,utf8.len(msg.TheRankCmd)) 
else 
redis:del(vzaec.."lock_bots_by_kick"..msg.chat_id_)
redis:del(vzaec.."lock_bots"..msg.chat_id_)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(vzaec.."mute_gif"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(vzaec.."mute_game"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(vzaec.."mute_photo"..msg.chat_id_)then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(vzaec.."mute_forward"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(vzaec.."lock_bots_by_kick"..msg.chat_id_) then
