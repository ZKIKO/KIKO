...
if redis:get(neyzk.."lock_KickBan"..msg.chat_id_) then 
...
else redis:set(neyzk.."lock_KickBan"..msg.chat_id_,true)
...
function lock_check(msg)
    ...
    redis:set(neyzk.."lock_check"..msg.chat_id_,true)
...
else redis:set(neyzk.."idphoto"..msg.chat_id_,true)
...
else redis:set(neyzk.."lock_woring"..msg.chat_id_,true)
...
redis:set(neyzk.."lock_id"..msg.chat_id_,true)  
...
else redis:set(neyzk.."welcome:get"..msg.chat_id_,true)  
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(neyzk.."welcome:get"..msg.chat_id_) then 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:mset(
neyzk.."lock_username"..msg.chat_id_,true,
neyzk.."mute_gif"..msg.chat_id_,true,
neyzk.."mute_photo"..msg.chat_id_,true,
neyzk.."mute_audio"..msg.chat_id_,true,
neyzk.."mute_voice"..msg.chat_id_,true,
neyzk.."mute_sticker"..msg.chat_id_,true,
neyzk.."mute_forward"..msg.chat_id_,true,
neyzk.."mute_contact"..msg.chat_id_,true,
neyzk.."mute_location"..msg.chat_id_,true,
neyzk.."mute_document"..msg.chat_id_,true,
neyzk.."lock_link"..msg.chat_id_,true,
neyzk.."lock_tag"..msg.chat_id_,true,
neyzk.."lock_edit"..msg.chat_id_,true,
neyzk.."lock_spam"..msg.chat_id_,true,
neyzk.."lock_bots"..msg.chat_id_,true,
neyzk.."lock_webpage"..msg.chat_id_,true,
neyzk.."mute_video"..msg.chat_id_,true,
neyzk.."mute_inline"..msg.chat_id_,true
)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(
neyzk.."lock_username"..msg.chat_id_,
neyzk.."mute_gif"..msg.chat_id_,
neyzk.."mute_photo"..msg.chat_id_,
neyzk.."mute_audio"..msg.chat_id_,
neyzk.."mute_voice"..msg.chat_id_,
neyzk.."mute_sticker"..msg.chat_id_,
neyzk.."mute_forward"..msg.chat_id_,
neyzk.."mute_contact"..msg.chat_id_,
neyzk.."mute_location"..msg.chat_id_,
neyzk.."mute_document"..msg.chat_id_,
neyzk.."lock_link"..msg.chat_id_,
neyzk.."lock_tag"..msg.chat_id_,
neyzk.."lock_edit"..msg.chat_id_,
neyzk.."lock_spam"..msg.chat_id_,
neyzk.."lock_bots"..msg.chat_id_,
neyzk.."lock_webpage"..msg.chat_id_,
neyzk.."mute_video"..msg.chat_id_,
neyzk..":tqeed_video:"..msg.chat_id_,
neyzk..":tqeed_photo:"..msg.chat_id_,
neyzk..":tqeed_gif:"..msg.chat_id_,
neyzk..":tqeed_fwd:"..msg.chat_id_,
neyzk..":tqeed_link:"..msg.chat_id_,
neyzk.."mute_inline"..msg.chat_id_
)
...
if redis:get(neyzk..":tqeed_photo:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالصور بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(neyzk.."mute_photo"..msg.chat_id_)
redis:set(neyzk..":tqeed_photo:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(neyzk..":tqeed_video:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالفيديو بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(neyzk..":tqeed_video:"..msg.chat_id_)
redis:set(neyzk..":tqeed_video:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(neyzk..":tqeed_video:"..msg.chat_id_) then
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(neyzk..":tqeed_gif:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد الممتحركه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(neyzk.."mute_gif"..msg.chat_id_)
redis:set(neyzk..":tqeed_gif:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(neyzk..":tqeed_fwd:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالتوجيه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(neyzk.."mute_forward"..msg.chat_id_)
redis:set(neyzk..":tqeed_fwd:"..msg.chat_id_,true)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(neyzk.."lock_bots"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." البوتات بالتأكيد تم فتحها \n✓",16,utf8.len(msg.TheRankCmd)) 
else 
redis:del(neyzk.."lock_bots_by_kick"..msg.chat_id_)
redis:del(neyzk.."lock_bots"..msg.chat_id_)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(neyzk.."mute_gif"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(neyzk.."mute_game"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(neyzk.."mute_photo"..msg.chat_id_)then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(neyzk.."mute_forward"..msg.chat_id_) then
...
redis:set(neyzk.."mute_tgservice"..msg.chat_id_,true)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(neyzk.."lock_bots_by_kick"..msg.chat_id_) then
