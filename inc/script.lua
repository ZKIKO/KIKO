...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(neyzk.."lock_KickBan"..msg.chat_id_) then return "📛*¦* الامر معطل من قبل اداره المجموعة  \n🚶" end
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not redis:get(neyzk.."lockidedit") then return "📛*¦* تعيين الايدي معطل من قبل المطور الاساسي  \n🚶" end
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://raw.githubusercontent.com/th3nek/NeyzkFile/master/GetFiles.json') or 0
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : النيزك 🍃",url="t.me/th3nek"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : النيزك](t.me/th3nek)',nil,inline,msg.id_)
return false
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(neyzk..":awamer_Klesha_m:") or text
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(neyzk..":awamer_Klesha_m1:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(neyzk..":awamer_Klesha_m2:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(neyzk..":awamer_Klesha_m3:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(neyzk..":awamer_Klesha_mtwr:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(neyzk..":awamer_Klesha_mrd:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(neyzk..":awamer_Klesha_mf:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/th3nek/NeyzkFile/master/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/th3nek/NeyzkFile/master/plugins/"..FileName)
if res == 200 then
...
redis:hset(neyzk..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
...
redis:hset(neyzk..'replay:all',klma,Flter_Markdown(msg.text))
