...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(vzaec..":NameBot:") or "تاو"
...
var = ' المنشىء اساسي👷🏽' 
elseif redis:sismember(vzaec..':zsaubot:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
...
function TagAll(msg)
  ...
  local monsha = redis:smembers(vzaec..':zsaubot:'..msg.chat_id_)
...
local creator = redis:smembers(vzaec..':zsaubot:'..GroupS)
if #creator ~= 0 then
