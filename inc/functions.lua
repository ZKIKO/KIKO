...
download_file('https://raw.githubusercontent.com/vzaec/vzaec/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/vzaec/vzaec/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/vzaec/vzaec/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/vzaec/vzaec/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(vzaec..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(vzaec..":NameBot:") or "نيزك"
...
usernn = data.username_ or "vzaec"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "vzaec"
end
Name = Name:gsub('[[][]]','')
...
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(vzaec..':MONSHA_Group:'..ChatID,UserID) then
var = ' المنشىء اساسي👷🏽' 
elseif redis:sismember(vzaec..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(vzaec..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(vzaec..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(vzaec..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(vzaec..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(vzaec..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(vzaec..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(vzaec..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(vzaec..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(vzaec..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(vzaec..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(vzaec..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(vzaec..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
function TagAll(msg)
  ...
  local monshaas = redis:smembers(vzaec..':MONSHA_Group:'..msg.chat_id_)
  local monsha = redis:smembers(vzaec..':MONSHA_BOT:'..msg.chat_id_)
  local Owners = redis:smembers(vzaec..'owners:'..msg.chat_id_)
  local Admins = redis:smembers(vzaec..'admins:'..msg.chat_id_)
  local mmez = redis:smembers(vzaec..'whitelist:'..msg.chat_id_)
...
for k,v in pairs(mmez) do
  ...
  local info  = redis:hgetall(vzaec..'username:'..v)
  if info and info.username and info.username:match("@[%a%d_]+") then
  message = message ..i.."-l ["..info.username..'] \n'
  else
  message = message ..i.. '-l ['..info.username..'](t.me/vzaec) \n'
  end
...
local list = redis:smembers(vzaec..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(vzaec..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(vzaec..'username:'..v)
local count = redis:scard(vzaec..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`){'..count..'} \n'
else
message = message ..k.. '-l ['..info.username..'](t.me/vzaec) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
function conslist(msg)
    ...
    local monsha = redis:smembers(vzaec..':MONSHA_Group:'..msg.chat_id_)
    if #monsha == 0 then 
    ...
    message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`) \n'
      ...
      message = message ..k.. '-l ['..info.username..'](t.me/vzaec) l » (`' ..v.. '`) \n'
    end
    end
    end
...
local list = redis:smembers(vzaec..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(vzaec..'admins:'..msg.chat_id_)
...
local list = redis:smembers(vzaec..'whitelist:'..msg.chat_id_)
...
if redis:sismember(vzaec..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(vzaec..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(vzaec..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(vzaec..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(vzaec..'gban_users')
...
if not msg.Admin and not msg.Special then -- للاعضاء فقط  
  local list = redis:smembers(vzaec..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(vzaec..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(vzaec..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(vzaec..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(vzaec..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(vzaec..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(vzaec..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..vzaec..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(vzaec..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(vzaec..'group:name'..GroupS) or '')
...
local admins = redis:smembers(vzaec..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(vzaec..'username:'..value)
if info then 
...
local creator = redis:smembers(vzaec..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(vzaec..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(vzaec..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(vzaec..'group:name'..v)
if info then 
...
redis:del(
vzaec..'group:add'..id_group,
vzaec..'lock_link'..id_group, 
vzaec..'lock_id'..id_group,
vzaec..'lock_spam'..id_group, 
vzaec..'lock_webpage'..id_group,
vzaec..'lock_markdown'..id_group,
vzaec..'lock_flood'..id_group,
vzaec..'lock_bots'..id_group,
vzaec..'mute_forward'..id_group,
vzaec..'mute_contact'..id_group,
vzaec..'mute_location'..id_group,
vzaec..'mute_document'..id_group,
vzaec..'mute_keyboard'..id_group,
vzaec..'mute_game'..id_group,
vzaec..'mute_inline'..id_group,
vzaec..'lock_username'..id_group,
vzaec..'num_msg_max'..id_group,
vzaec..'mute_text'..id_group,
vzaec..'admins:'..id_group,
vzaec..':Filter_Word:'..id_group,
vzaec..'banned:'..id_group,
vzaec..'is_silent_users:'..id_group,
vzaec..'whitelist:'..id_group,
vzaec..':MONSHA_BOT:'..id_group,
vzaec..'owners:'..id_group,
vzaec..'replay'..id_group,
vzaec..':MONSHA_Group:'..id_group
)
redis:srem(vzaec..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(vzaec..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(vzaec..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(vzaec..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(vzaec..'group:add'..msg.chat_id_) then  return '🎗*¦* المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
local GroupUsers = tonumber(redis:get(vzaec..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(vzaec..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(vzaec..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
vzaec..'group:add'..arg.chat_id_,true,
vzaec..'lock_link'..arg.chat_id_,true, 
vzaec..'lock_id'..arg.chat_id_,true,
vzaec..'lock_spam'..arg.chat_id_,true,
vzaec..'lock_webpage'..arg.chat_id_,true,
vzaec..'lock_markdown'..arg.chat_id_,true,
vzaec..'lock_flood'..arg.chat_id_,true,
vzaec..'lock_bots'..arg.chat_id_,true,
vzaec..'mute_forward'..arg.chat_id_,true,
vzaec..'mute_contact'..arg.chat_id_,true,
vzaec..'mute_location'..arg.chat_id_,true,
vzaec..'mute_document'..arg.chat_id_,true,
vzaec..'mute_keyboard'..arg.chat_id_,true,
vzaec..'mute_game'..arg.chat_id_,true,
vzaec..'mute_inline'..arg.chat_id_,true,
vzaec..'lock_username'..arg.chat_id_,true,
vzaec..'num_msg_max'..arg.chat_id_,5, 
vzaec..'lock_edit'..arg.chat_id_,true,
vzaec..'replay'..arg.chat_id_,true,
vzaec.."lock_KickBan"..msg.chat_id_,true,
vzaec.."lock_mmno3"..msg.chat_id_,true,
vzaec.."lock_KickBan"..msg.chat_id_,true,
vzaec.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(vzaec..'group:ids',arg.chat_id_) 
redis:sadd(vzaec..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(vzaec..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(vzaec..'linkGroup'..arg.chat_id_,Gp_Link)
...
if cmd == "Upmonsh" then
if redis:sismember(vzaec..':MONSHA_Group:'..ChatID,UserID) then 
...
redis:sadd(vzaec..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮 » تم رفع ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(vzaec..':MONSHA_Group:'..ChatID,UserID) then 
sendMsg(ChatID,MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️") 
end
redis:srem(vzaec..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(vzaec..'username:'..UserID, 'username', Resolv)
redis:sadd(vzaec..'banned:'..ChatID,UserID)
...
redis:hset(vzaec..'username:'..UserID, 'username', Resolv)
redis:srem(vzaec..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(vzaec..'username:'..UserID, 'username', Resolv)
redis:sadd(vzaec..'is_silent_users:'..ChatID,UserID)
...
redis:hset(vzaec..'username:'..UserID, 'username', Resolv)
redis:srem(vzaec..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم الغاء كتمه من المجموعة\n✓") 
end

if cmd == "upMshrf" then
  redis:hset(vzaec..'username:'..UserID,'username',Resolv)
  redis:setex(vzaec..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
  redis:setex(vzaec..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
  local maseegs = redis:get(vzaec..'msgs:'..UserID..':'..ChatID) or 1
  local edited = redis:get(vzaec..':edited:'..ChatID..':'..UserID) or 0
  local content = redis:get(vzaec..':adduser:'..ChatID..':'..UserID) or 0
  if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
.."\n📝¦ التعديل » "..(redis:get(vzaec..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(vzaec..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(vzaec..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(vzaec..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(vzaec..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(vzaec..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(vzaec..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(vzaec..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(vzaec..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(vzaec..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(vzaec..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(vzaec..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(vzaec..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(vzaec..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(vzaec..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(vzaec..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(vzaec..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(vzaec..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(vzaec..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(vzaec..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(vzaec..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(vzaec..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(vzaec..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(vzaec..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(vzaec..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(vzaec..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(vzaec..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(vzaec..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(vzaec..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(vzaec..'welcome:get'..msg.chat_id_) or 'false')
.."\n*💬¦*  الردود » "..(redis:get(vzaec..'replay'..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(vzaec..'lock_woring'..msg.chat_id_) or 'false')
.."\n*🎫¦* الايدي » "..(redis:get(vzaec..'lock_id'..msg.chat_id_) or 'false')
.."\n*🎫¦* الرابط » "..(redis:get(vzaec..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*🎫¦* المغادره » "..(redis:get(vzaec..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🎫¦* الحظر » "..(redis:get(vzaec..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🎫¦* الحمايه » "..(redis:get(vzaec..'antiedit'..msg.chat_id_) or 'false')
.."\n*🎫¦* التاك للكل » "..(redis:get(vzaec..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*🎫¦* الايدي بالصوره » "..(redis:get(vzaec..'idphoto'..msg.chat_id_) or 'false')
.."\n*🎫¦* التحقق » "..(redis:get(vzaec.."lock_check"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(vzaec..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(vzaec..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(vzaec..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(vzaec..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(vzaec..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(vzaec..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(vzaec..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(vzaec..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(vzaec..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
