...
download_file('https://raw.githubusercontent.com/ZKIKO/KIKO/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/ZKIKO/KIKO/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/ZKIKO/KIKO/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/ZKIKO/KIKO/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(KIKO..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(KIKO..":NameBot:") or "كيكو"
...
usernn = data.username_ or "BOTKIKO"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "BOTKIKO"
end
Name = Name:gsub('[[][]]','')
...
local Fshar_Word , res = https.request('https://KIKO.tk/Words_Fshars.txt')
...
Fshar_Word , res = https.request('https://KIKO.tk/Words_Fshars.txt')
if res ~= 200 then Fshar_Word = "\n" end
...
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(KIKO..':MONSHA_Group:'..ChatID,UserID) then
var = ' المنشىء اساسي👷🏽' 
elseif redis:sismember(KIKO..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(KIKO..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(KIKO..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(KIKO..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
Replay = Replay:gsub("{البوت}",redis:get(KIKO..':NameBot:'))
...
if msg.edited then
redis:incr(KIKO..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(KIKO..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(KIKO..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(KIKO..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(KIKO..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(KIKO..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(KIKO..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(KIKO..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(KIKO..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(KIKO..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(KIKO..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(KIKO..'owners:'..msg.chat_id_)
local Admins = redis:smembers(KIKO..'admins:'..msg.chat_id_)
local mmez = redis:smembers(KIKO..'whitelist:'..msg.chat_id_)
...
local info  = redis:hgetall(KIKO..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..i.."-l ["..info.username..'] \n'
else
message = message ..i.. '-l ['..info.username..'](t.me/BOTKIKO) \n'
end
...
local list = redis:smembers(KIKO..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(KIKO..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(KIKO..'username:'..v)
local count = redis:scard(KIKO..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`){'..count..'} \n'
else
message = message ..k.. '-l ['..info.username..'](t.me/BOTKIKO) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/BOTKIKO) l » (`' ..v.. '`) \n'
end
end
end
...
local list = redis:smembers(KIKO..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(KIKO..'admins:'..msg.chat_id_)
...
local list = redis:smembers(KIKO..'whitelist:'..msg.chat_id_)
...
if redis:sismember(KIKO..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(KIKO..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(KIKO..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(KIKO..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(KIKO..'gban_users')
...
local list = redis:smembers(KIKO..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(KIKO..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(KIKO..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(KIKO..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(KIKO..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(KIKO..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(KIKO..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..KIKO..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(KIKO..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(KIKO..'group:name'..GroupS) or '')
...
local admins = redis:smembers(KIKO..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(KIKO..'username:'..value)
if info then 
...
local creator = redis:smembers(KIKO..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(KIKO..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(KIKO..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(KIKO..'group:name'..v)
if info then 
...
redis:del(
KIKO..'group:add'..id_group,
KIKO..'lock_link'..id_group, 
KIKO..'lock_id'..id_group,
KIKO..'lock_spam'..id_group, 
KIKO..'lock_webpage'..id_group,
KIKO..'lock_markdown'..id_group,
KIKO..'lock_flood'..id_group,
KIKO..'lock_bots'..id_group,
KIKO..'mute_forward'..id_group,
KIKO..'mute_contact'..id_group,
KIKO..'mute_location'..id_group,
KIKO..'mute_document'..id_group,
KIKO..'mute_keyboard'..id_group,
KIKO..'mute_game'..id_group,
KIKO..'mute_inline'..id_group,
KIKO..'lock_username'..id_group,
KIKO..'num_msg_max'..id_group,
KIKO..'mute_text'..id_group,
KIKO..'admins:'..id_group,
KIKO..':Filter_Word:'..id_group,
KIKO..'banned:'..id_group,
KIKO..'is_silent_users:'..id_group,
KIKO..'whitelist:'..id_group,
KIKO..':MONSHA_BOT:'..id_group,
KIKO..'owners:'..id_group,
KIKO..'replay'..id_group,
KIKO..':MONSHA_Group:'..id_group
)
redis:srem(KIKO..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(KIKO..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(KIKO..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(KIKO..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(KIKO..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'📮¦ بواسطه ⋙「 '..NameUser..' 」 \n📬¦ المجموعه بالتأكيد ✓️ تم تفعيلها \n✓️') end
...
local GroupUsers = tonumber(redis:get(KIKO..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(KIKO..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(KIKO..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
KIKO..'group:add'..arg.chat_id_,true,
KIKO..'lock_link'..arg.chat_id_,true, 
KIKO..'lock_id'..arg.chat_id_,true,
KIKO..'lock_spam'..arg.chat_id_,true,
KIKO..'lock_webpage'..arg.chat_id_,true,
KIKO..'lock_markdown'..arg.chat_id_,true,
KIKO..'lock_flood'..arg.chat_id_,true,
KIKO..'lock_bots'..arg.chat_id_,true,
KIKO..'mute_forward'..arg.chat_id_,true,
KIKO..'mute_contact'..arg.chat_id_,true,
KIKO..'mute_location'..arg.chat_id_,true,
KIKO..'mute_document'..arg.chat_id_,true,
KIKO..'mute_keyboard'..arg.chat_id_,true,
KIKO..'mute_game'..arg.chat_id_,true,
KIKO..'mute_inline'..arg.chat_id_,true,
KIKO..'lock_username'..arg.chat_id_,true,
KIKO..'num_msg_max'..arg.chat_id_,5, 
KIKO..'lock_edit'..arg.chat_id_,true,
KIKO..'replay'..arg.chat_id_,true,
KIKO..'lock_rdodSource'..arg.chat_id_,true,
KIKO.."lock_KickBan"..msg.chat_id_,true,
KIKO.."lock_mmno3"..msg.chat_id_,true,
KIKO.."lock_KickBan"..msg.chat_id_,true,
KIKO.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(KIKO..'group:ids',arg.chat_id_) 
redis:sadd(KIKO..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(KIKO..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(KIKO..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:hset(KIKO..'username:'..UserID, 'username', Resolv)
redis:sadd(KIKO..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم تقييده بنجاح \n✓")
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(KIKO..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده بنجاح \n✓")
end
if cmd == "setwhitelist" then
if redis:sismember(KIKO..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مميز  في المجموعه \n✓") 
end
redis:hset(KIKO..'username:'..UserID, 'username', Resolv)
redis:sadd(KIKO..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مميز  في المجموعه \n✓") 
end
if cmd == "remwhitelist" then
if not redis:sismember(KIKO..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
end
redis:srem(KIKO..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مميز  في المجموعه \n✓") 
end
if cmd == "setmnsha" then
if redis:sismember(KIKO..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ  في المجموعه \n✓") 
end
redis:hset(KIKO..'username:'..UserID, 'username', Resolv)
redis:sadd(KIKO..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته منشئ  في المجموعه \n✓") 
end
if cmd == "remmnsha" then
if not redis:sismember(KIKO..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
end
redis:srem(KIKO..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشى  في المجموعه \n✓") 
end

if cmd == "setowner" then
if redis:sismember(KIKO..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مدير  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(KIKO..'username:'..UserID, 'username', Resolv)
redis:sadd(KIKO..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مدير  في المجموعه \n✓") 
end
if cmd == "remowner" then
if not redis:sismember(KIKO..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
end
redis:srem(KIKO..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه \n✓") 
end
if cmd == "promote" then
if redis:sismember(KIKO..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته ادمن  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(KIKO..'username:'..UserID, 'username', Resolv)
redis:sadd(KIKO..'admins:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته ادمن  في المجموعه \n✓") 
end
if cmd == "demote" then
if not redis:sismember(KIKO..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
end
redis:srem(KIKO..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(KIKO..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ اساسي  في المجموعه \n✓") 
end
redis:hset(KIKO..'username:'..UserID,'username',USERNAME)
redis:sadd(KIKO..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(KIKO..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
end
redis:srem(KIKO..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(KIKO..'username:'..UserID, 'username', Resolv)
redis:sadd(KIKO..'banned:'..ChatID,UserID)
...
redis:hset(KIKO..'username:'..UserID, 'username', Resolv)
redis:srem(KIKO..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(KIKO..'username:'..UserID, 'username', Resolv)
redis:sadd(KIKO..'is_silent_users:'..ChatID,UserID)
...
redis:hset(KIKO..'username:'..UserID, 'username', Resolv)
redis:srem(KIKO..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه \n✓") 
end

if cmd == "upMshrf" then
redis:hset(KIKO..'username:'..UserID,'username',Resolv)
redis:setex(KIKO..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(KIKO..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
local maseegs = redis:get(KIKO..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(KIKO..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(KIKO..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
.."\n📝¦ التعديل » "..(redis:get(KIKO..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(KIKO..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(KIKO..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(KIKO..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(KIKO..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(KIKO..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(KIKO..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(KIKO..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(KIKO..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(KIKO..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(KIKO..'num_msg_max'..msg.chat_id_) or 'false')
.."\n⏰¦ وقت التنظيف » "..(redis:get(KIKO..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(KIKO..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(KIKO..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(KIKO..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(KIKO..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(KIKO..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(KIKO..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(KIKO..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(KIKO..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(KIKO..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(KIKO..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(KIKO..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(KIKO..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(KIKO..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(KIKO..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(KIKO..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(KIKO..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(KIKO..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(KIKO..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(KIKO..'welcome:get'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود » "..(redis:get(KIKO..'replay'..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(KIKO..'lock_woring'..msg.chat_id_) or 'false')
.."\n*📝¦* الايدي » "..(redis:get(KIKO..'lock_id'..msg.chat_id_) or 'false')
.."\n*💬¦* الرابط » "..(redis:get(KIKO..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*📮¦* المغادره » "..(redis:get(KIKO..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🗳¦* الحظر » "..(redis:get(KIKO..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🔍¦* الحمايه » "..(redis:get(KIKO..'antiedit'..msg.chat_id_) or 'false')
.."\n*📋¦* التاك للكل » "..(redis:get(KIKO..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*📒¦* الايدي بالصوره » "..(redis:get(KIKO..'idphoto'..msg.chat_id_) or 'false')
.."\n*🔐¦* التحقق » "..(redis:get(KIKO.."lock_check"..msg.chat_id_) or 'false')
.."\n*🗑¦* التنظيف التلقائي » "..(redis:get(KIKO.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*📂¦* ردود السورس » "..(redis:get(KIKO.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(KIKO..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(KIKO..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(KIKO..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(KIKO..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(KIKO..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(KIKO..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(KIKO..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(KIKO..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(KIKO..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
