...
download_file('https://raw.githubusercontent.com/nizks/nizks/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/nizks/nizks/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/nizks/nizks/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/nizks/nizks/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(nizks..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(nizks..":NameBot:") or "نيزك"
...
usernn = data.username_ or "nizks"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "nizks"
end
Name = Name:gsub('[[][]]','')
...
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(nizks..':MONSHA_Group:'..ChatID,UserID) then
var = ' المنشىء اساسي👷🏽' 
elseif redis:sismember(nizks..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(nizks..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(nizks..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(nizks..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(nizks..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(nizks..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(nizks..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(nizks..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(nizks..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(nizks..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(nizks..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(nizks..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(nizks..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
function TagAll(msg)
  ...
  local monshaas = redis:smembers(nizks..':MONSHA_Group:'..msg.chat_id_)
  local monsha = redis:smembers(nizks..':MONSHA_BOT:'..msg.chat_id_)
  local Owners = redis:smembers(nizks..'owners:'..msg.chat_id_)
  local Admins = redis:smembers(nizks..'admins:'..msg.chat_id_)
  local mmez = redis:smembers(nizks..'whitelist:'..msg.chat_id_)
...
for k,v in pairs(mmez) do
  ...
  local info  = redis:hgetall(nizks..'username:'..v)
  if info and info.username and info.username:match("@[%a%d_]+") then
  message = message ..i.."-l ["..info.username..'] \n'
  else
  message = message ..i.. '-l ['..info.username..'](t.me/nizks) \n'
  end
...
local list = redis:smembers(nizks..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(nizks..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(nizks..'username:'..v)
local count = redis:scard(nizks..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`){'..count..'} \n'
else
message = message ..k.. '-l ['..info.username..'](t.me/nizks) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
function conslist(msg)
    ...
    local monsha = redis:smembers(nizks..':MONSHA_Group:'..msg.chat_id_)
    if #monsha == 0 then 
    ...
    message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`) \n'
      ...
      message = message ..k.. '-l ['..info.username..'](t.me/nizks) l » (`' ..v.. '`) \n'
    end
    end
    end
...
local list = redis:smembers(nizks..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(nizks..'admins:'..msg.chat_id_)
...
local list = redis:smembers(nizks..'whitelist:'..msg.chat_id_)
...
if redis:sismember(nizks..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(nizks..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(nizks..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(nizks..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(nizks..'gban_users')
...
if not msg.Admin and not msg.Special then -- للاعضاء فقط  
  local list = redis:smembers(nizks..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(nizks..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(nizks..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(nizks..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(nizks..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(nizks..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(nizks..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..nizks..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(nizks..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(nizks..'group:name'..GroupS) or '')
...
local admins = redis:smembers(nizks..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(nizks..'username:'..value)
if info then 
...
local creator = redis:smembers(nizks..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(nizks..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(nizks..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(nizks..'group:name'..v)
if info then 
...
redis:del(
nizks..'group:add'..id_group,
nizks..'lock_link'..id_group, 
nizks..'lock_id'..id_group,
nizks..'lock_spam'..id_group, 
nizks..'lock_webpage'..id_group,
nizks..'lock_markdown'..id_group,
nizks..'lock_flood'..id_group,
nizks..'lock_bots'..id_group,
nizks..'mute_forward'..id_group,
nizks..'mute_contact'..id_group,
nizks..'mute_location'..id_group,
nizks..'mute_document'..id_group,
nizks..'mute_keyboard'..id_group,
nizks..'mute_game'..id_group,
nizks..'mute_inline'..id_group,
nizks..'lock_username'..id_group,
nizks..'num_msg_max'..id_group,
nizks..'mute_text'..id_group,
nizks..'admins:'..id_group,
nizks..':Filter_Word:'..id_group,
nizks..'banned:'..id_group,
nizks..'is_silent_users:'..id_group,
nizks..'whitelist:'..id_group,
nizks..':MONSHA_BOT:'..id_group,
nizks..'owners:'..id_group,
nizks..'replay'..id_group,
nizks..':MONSHA_Group:'..id_group
)
redis:srem(nizks..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(nizks..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(nizks..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(nizks..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(nizks..'group:add'..msg.chat_id_) then  return '🎗*¦* المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
local GroupUsers = tonumber(redis:get(nizks..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(nizks..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(nizks..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
nizks..'group:add'..arg.chat_id_,true,
nizks..'lock_link'..arg.chat_id_,true, 
nizks..'lock_id'..arg.chat_id_,true,
nizks..'lock_spam'..arg.chat_id_,true,
nizks..'lock_webpage'..arg.chat_id_,true,
nizks..'lock_markdown'..arg.chat_id_,true,
nizks..'lock_flood'..arg.chat_id_,true,
nizks..'lock_bots'..arg.chat_id_,true,
nizks..'mute_forward'..arg.chat_id_,true,
nizks..'mute_contact'..arg.chat_id_,true,
nizks..'mute_location'..arg.chat_id_,true,
nizks..'mute_document'..arg.chat_id_,true,
nizks..'mute_keyboard'..arg.chat_id_,true,
nizks..'mute_game'..arg.chat_id_,true,
nizks..'mute_inline'..arg.chat_id_,true,
nizks..'lock_username'..arg.chat_id_,true,
nizks..'num_msg_max'..arg.chat_id_,5, 
nizks..'lock_edit'..arg.chat_id_,true,
nizks..'replay'..arg.chat_id_,true,
nizks.."lock_KickBan"..msg.chat_id_,true,
nizks.."lock_mmno3"..msg.chat_id_,true,
nizks.."lock_KickBan"..msg.chat_id_,true,
nizks.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(nizks..'group:ids',arg.chat_id_) 
redis:sadd(nizks..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(nizks..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(nizks..'linkGroup'..arg.chat_id_,Gp_Link)
...
if cmd == "Upmonsh" then
if redis:sismember(nizks..':MONSHA_Group:'..ChatID,UserID) then 
...
redis:sadd(nizks..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮 » تم رفع ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(nizks..':MONSHA_Group:'..ChatID,UserID) then 
sendMsg(ChatID,MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️") 
end
redis:srem(nizks..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(nizks..'username:'..UserID, 'username', Resolv)
redis:sadd(nizks..'banned:'..ChatID,UserID)
...
redis:hset(nizks..'username:'..UserID, 'username', Resolv)
redis:srem(nizks..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(nizks..'username:'..UserID, 'username', Resolv)
redis:sadd(nizks..'is_silent_users:'..ChatID,UserID)
...
redis:hset(nizks..'username:'..UserID, 'username', Resolv)
redis:srem(nizks..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم الغاء كتمه من المجموعة\n✓") 
end

if cmd == "upMshrf" then
  redis:hset(nizks..'username:'..UserID,'username',Resolv)
  redis:setex(nizks..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
  redis:setex(nizks..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
  local maseegs = redis:get(nizks..'msgs:'..UserID..':'..ChatID) or 1
  local edited = redis:get(nizks..':edited:'..ChatID..':'..UserID) or 0
  local content = redis:get(nizks..':adduser:'..ChatID..':'..UserID) or 0
  if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
.."\n📝¦ التعديل » "..(redis:get(nizks..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(nizks..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(nizks..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(nizks..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(nizks..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(nizks..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(nizks..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(nizks..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(nizks..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(nizks..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(nizks..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(nizks..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(nizks..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(nizks..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(nizks..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(nizks..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(nizks..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(nizks..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(nizks..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(nizks..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(nizks..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(nizks..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(nizks..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(nizks..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(nizks..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(nizks..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(nizks..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(nizks..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(nizks..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(nizks..'welcome:get'..msg.chat_id_) or 'false')
.."\n*💬¦*  الردود » "..(redis:get(nizks..'replay'..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(nizks..'lock_woring'..msg.chat_id_) or 'false')
.."\n*🎫¦* الايدي » "..(redis:get(nizks..'lock_id'..msg.chat_id_) or 'false')
.."\n*🎫¦* الرابط » "..(redis:get(nizks..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*🎫¦* المغادره » "..(redis:get(nizks..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🎫¦* الحظر » "..(redis:get(nizks..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🎫¦* الحمايه » "..(redis:get(nizks..'antiedit'..msg.chat_id_) or 'false')
.."\n*🎫¦* التاك للكل » "..(redis:get(nizks..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*🎫¦* الايدي بالصوره » "..(redis:get(nizks..'idphoto'..msg.chat_id_) or 'false')
.."\n*🎫¦* التحقق » "..(redis:get(nizks.."lock_check"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(nizks..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(nizks..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(nizks..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(nizks..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(nizks..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(nizks..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(nizks..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(nizks..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(nizks..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
