...
local GetVerisonvzaec = https.request('https://raw.githubusercontent.com/vzaec/vzaecFile/master/GetVersion.txt') or 0
print('\n\27[1;36m￤تم آدخآل آيدي آلمـطـور بنجآح , سـوف يتم تشـغيل آلسـورس آلآن .\n￤Success Save USERID : \27[0;32m['..SUDO_USER..']\n\27[0;39;49m')
vzaec = Token:match("(%d+)")
redis:mset(
vzaec..":VERSION",GetVerisonvzaec,
vzaec..":SUDO_ID:",SUDO_USER,
vzaec..":DataCenter:",'Amsterdam',
vzaec..":UserNameBot:",BOT_User,
vzaec..":ApiSource",'http://th3nezk.aba.vg/',
vzaec..":NameBot:","تاو",
"TH3vzaec_INSTALL","Yes"
)
redis:hset(vzaec..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
info = {} 
...
vzaec = Token:match("(%d+)")
our_id = tonumber(vzaec)
Apivzaec = redis:get(vzaec..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(vzaec..":UserNameBot:")
SUDO_ID = tonumber(redis:get(vzaec..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(vzaec..'username:'..SUDO_ID).username
version = redis:get(vzaec..":VERSION")
DataCenter = redis:get(vzaec..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..vzaec..')\027[0;32m\n'
...
..'¦ Api_Src->: \27[1;34m'..Apivzaec..'\027[0;32m\n'
...
if not redis:get(vzaec..":Check_Bot:"..W) then
Rgz,res=http.request(Apivzaec..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(vzaec..":Check_Bot:"..W,1800,true) return false else return Rgz end 
end 
end
...
if msg.type == "pv" and redis:get(vzaec..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(vzaec..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(vzaec..'group:add'..msg.chat_id_) then 
...
if msg.GroupActive and redis:get(vzaec..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end
...
msg.Rank = 1
elseif redis:sismember(vzaec..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'المطور'
msg.TheRank = 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(vzaec..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'منشئ اساسي'
msg.TheRank = 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(vzaec..':zsaubot:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء'
msg.TheRank = 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(vzaec..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير' 
msg.TheRank = 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(vzaec..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن'
msg.TheRank = 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(vzaec..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(vzaec..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(vzaec..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(vzaec..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(vzaec..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(vzaec..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(vzaec..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(vzaec.."lock_Add"..msg.chat_id_) then
...
if msg.Special or msg.Admin then redis:srem(vzaec..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(vzaec..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(vzaec..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.vzaec then 
if msg.text and ScriptFile.ivzaec then
Xvzaec = ScriptFile.vzaec
local list = redis:hgetall(vzaec..":AwamerBotArray:"..msg.chat_id_)
for vzaec2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(vzaec2) then 
local amrr = {Text:match(vzaec2)}
local AmrOld = redis:hgetall(vzaec..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.ivzaec(msg,{Text:match(Text2)})
if GetMsg then
...
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(vzaec) then -- Check Commands To admin
AF = CheckBotA(msg) if AF then return sendMsg(msg.chat_id_,msg.id_,AF) end 
GetMsg = ScriptFile.ivzaec(msg,{Text:match(vzaec)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",vzaec.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end 
end
...
if ScriptFile.dvzaec then
if ScriptFile.dvzaec(msg) == false then
return false
end
...
if Plug.vzaec then 
if msg.text and Plug.ivzaec then
for k, vzaec in pairs(Plug.vzaec) do
if msg.text:match(vzaec) then
local GetMsg = Plug.ivzaec(msg,{msg.text:match(vzaec)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",vzaec.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
print("The File "..name.." Not Runing in The Source vzaec")
end 

end
else
print("The File Script.lua Not Runing in The Source vzaec")
end
end
...
function tdcli_update_callback(data)
	...
	redis:srem(vzaec..'users',msg.sender_user_id_)
	end
...
if redis:get(vzaec..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(vzaec..":propin"..msg.chat_id_)
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) vardump(d)end,nil)   
	...
	if redis:get(vzaec..'group:add'..data.chat_.id_) then
	redis:set(vzaec..'group:name'..data.chat_.id_,data.chat_.title_)
	end
	elseif data.ID == "UpdateChannel" then  
	if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
	if redis:get(vzaec..'group:add-100'..data.channel_.id_) then
	local linkGroup = (redis:get(vzaec..'linkGroup-100'..data.channel_.id_) or "")
	local NameGroup = (redis:get(vzaec..'group:name-100'..data.channel_.id_) or "")
	...
	redis:mset(
	vzaec..'group:name'..k,IDS.Title,
	vzaec..'num_msg_max'..k,5,
	vzaec..'group:add'..k,true,
	vzaec..'lock_link'..k,true,
	vzaec..'lock_spam'..k,true,
	vzaec..'lock_webpage'..k,true,
	vzaec..'lock_markdown'..k,true,
	vzaec..'lock_flood'..k,true,
	vzaec..'lock_bots'..k,true,
	vzaec..'mute_forward'..k,true,
	vzaec..'mute_contact'..k,true,
	vzaec..'mute_document'..k,true,
	vzaec..'mute_inline'..k,true,
	vzaec..'lock_username'..k,true,
	vzaec..'replay'..k,true
	)
	redis:sadd(vzaec..'group:ids',k) 

	if IDS.Admins then
	for user,ID in pairs(IDS.Admins) do
	redis:hset(vzaec..'username:'..ID,'username',user)
	redis:sadd(vzaec..'admins:'..k,ID)
	end
	end
	if IDS.Creator then
	for user,ID in pairs(IDS.Creator) do
	redis:hset(vzaec..'username:'..ID,'username',user)
	redis:sadd(vzaec..':zsaubot:'..k,ID)
	end
	end
	if IDS.Owner then
	for user,ID in pairs(IDS.Owner) do
	redis:hset(vzaec..'username:'..ID,'username',user)
	redis:sadd(vzaec..'owners:'..k,ID)
	end
	end
	end
	io.popen("rm -fr ../.telegram-cli/data/document/*")
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(vzaec..'group:ids')..'* 🌿\n✓')
	end
	elseif data.ID == "UpdateUser" then  
	if data.user_.type_.ID == "UserTypeDeleted" then
	print("¦ userTypeDeleted")
	redis:srem(vzaec..'users',data.user_.id_)
	elseif data.user_.type_.ID == "UserTypeGeneral" then
	local CheckUser = redis:hgetall(vzaec..'username:'..data.user_.id_).username
	...
	redis:hset(vzaec..'username:'..data.user_.id_,'username',USERNAME)
	end 
	end
