...
local GetVerisonKIKO = https.request('https://raw.githubusercontent.com/ZKIKO/KIKOFiles/master/GetVersion.txt') or 0
print('\n\27[1;36m￤تم آدخآل آيدي آلمـطـور بنجآح , سـوف يتم تشـغيل آلسـورس آلآن .\n￤Success Save ID : \27[0;32m['..SUDO_USER..']\n\27[0;39;49m')
KIKO = Token:match("(%d+)")
redis:mset(
KIKO..":VERSION",GetVerisonKIKO,
KIKO..":SUDO_ID:",SUDO_USER,
KIKO..":DataCenter:","Amsterdam",
KIKO..":UserNameBot:",BOT_User,
KIKO..":ApiSource","https://KIKO.tk/",
KIKO..":NameBot:","كيكو",
"KIKO_INSTALL","Yes"
)
redis:hset(KIKO..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
info = {} 
...
KIKO = Token:match("(%d+)")
our_id = tonumber(KIKO)
ApiKIKO = redis:get(KIKO..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(KIKO..":UserNameBot:")
SUDO_ID = tonumber(redis:get(KIKO..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(KIKO..'username:'..SUDO_ID).username
version = redis:get(KIKO..":VERSION")
DataCenter = redis:get(KIKO..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..KIKO..')\027[0;32m\n'
...
..'¦ Api_Src->: \27[1;34m'..ApiKIKO..'\027[0;32m\n'
...
if not redis:get(KIKO..":Check_Bot:"..W) then
Rgz,res=https.request(ApiKIKO..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(KIKO..":Check_Bot:"..W,1800,true) return false else return Rgz end 
end 
end
...
if msg.type == "pv" and redis:get(KIKO..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(KIKO..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(KIKO..'group:add'..msg.chat_id_) then 
...
and redis:get(KIKO.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(KIKO..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(KIKO..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(KIKO..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end



print(KIKO..":IdsMsgsCleaner:"..msg.chat_id_)
local Cleaner = redis:smembers(KIKO..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
if not redis:get(KIKO..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(KIKO..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(KIKO..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end
...
msg.Rank = 1
elseif redis:sismember(KIKO..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'المطور'
msg.TheRank = 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(KIKO..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'منشئ اساسي'
msg.TheRank = 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(KIKO..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء'
msg.TheRank = 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(KIKO..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير' 
msg.TheRank = 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(KIKO..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن'
msg.TheRank = 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(KIKO..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(KIKO..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(KIKO..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(KIKO..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(KIKO..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(KIKO..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(KIKO..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(KIKO.."lock_Add"..msg.chat_id_) then
...
if redis:get(KIKO.."lock_check"..msg.chat_id_) and not redis:get(KIKO..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(KIKO..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(KIKO..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(KIKO..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.KIKO then 
if msg.text and ScriptFile.iKIKO then
XKIKO = ScriptFile.KIKO
local list = redis:hgetall(KIKO..":AwamerBotArray:"..msg.chat_id_)
for KIKO2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(KIKO2) then 
local amrr = {Text:match(KIKO2)}
local AmrOld = redis:hgetall(KIKO..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.iKIKO(msg,{Text:match(Text2)})
if GetMsg then
...
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(KIKO) then -- Check Commands To admin
AF = CheckBotA(msg) if AF then return sendMsg(msg.chat_id_,msg.id_,AF) end 
GetMsg = ScriptFile.iKIKO(msg,{Text:match(KIKO)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",KIKO.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end 
end
...
if ScriptFile.dKIKO then
if ScriptFile.dKIKO(msg) == false then
return false
end
...
if Plug.KIKO then 
if msg.text and Plug.iKIKO then
for k, KIKO in pairs(Plug.KIKO) do
if msg.text:match(KIKO) then
local GetMsg = Plug.iKIKO(msg,{msg.text:match(KIKO)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",KIKO.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
print("The File "..name.." Not Runing in The Source KIKO")
end 

end
else
print("The File Script.lua Not Runing in The Source KIKO")
end
end
...
redis:srem(KIKO..'users',msg.sender_user_id_)
end
...
if redis:get(KIKO..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(KIKO..":propin"..msg.chat_id_)
...
if ApiKIKO ~= "https://KIKO.tk/" then
redis:set(KIKO..":ApiSource","https://KIKO.tk/")
end
...
if redis:get(KIKO..'group:add'..data.chat_.id_) then
redis:set(KIKO..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then  
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
if redis:get(KIKO..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(KIKO..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(KIKO..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
KIKO..'group:name'..k,IDS.Title,
KIKO..'num_msg_max'..k,5,
KIKO..'group:add'..k,true,
KIKO..'lock_link'..k,true,
KIKO..'lock_spam'..k,true,
KIKO..'lock_webpage'..k,true,
KIKO..'lock_markdown'..k,true,
KIKO..'lock_flood'..k,true,
KIKO..'lock_bots'..k,true,
KIKO..'mute_forward'..k,true,
KIKO..'mute_contact'..k,true,
KIKO..'mute_document'..k,true,
KIKO..'mute_inline'..k,true,
KIKO..'lock_username'..k,true,
KIKO..'replay'..k,true
)
redis:sadd(KIKO..'group:ids',k) 

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(KIKO..'username:'..ID,'username',user)
redis:sadd(KIKO..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(KIKO..'username:'..ID,'username',user)
redis:sadd(KIKO..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(KIKO..'username:'..ID,'username',user)
redis:sadd(KIKO..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(KIKO..'group:ids')..'* 🌿\n✓')
end
elseif data.ID == "UpdateUser" then  
if data.user_.type_.ID == "UserTypeDeleted" then
print("¦ userTypeDeleted")
redis:srem(KIKO..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(KIKO..'username:'..data.user_.id_).username
...
redis:hset(KIKO..'username:'..data.user_.id_,'username',USERNAME)
end 
end
