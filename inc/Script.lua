...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://THTSS.github.io/GetVersion.txt') or 0
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : الـزعـيـم 🍃",url="t.me/THTSS"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : الـزعـيـم](t.me/THTSS)',nil,inline,msg.id_)
return false
end
...
`git clone https://github.com/THTSS/NEYZK.git ;cd NEYZK;chmod +x ins;./ins`
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://THTSS.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
