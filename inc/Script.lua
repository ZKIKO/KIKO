...
if not MsgText[2] and msg.reply_id then 
  ...
  local UserID = data.sender_user_id_
  GetUserID(UserID,function(arg,data)
    if msg.SudoUser then redis:srem(neyzk..'gban_users',arg.UserID)  end 
    Restrict(arg.ChatID,arg.UserID,2)
  ...
  if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"📛*¦* لآ يوجد عضـو بهہ‌‏ذآ آلمـعرف \n❕") end 
  local UserID = data.id_
  if msg.SudoUser then redis:srem(neyzk..'gban_users',UserID)  end 
  Restrict(arg.ChatID,UserID,2)
...
redis:set(neyzk..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://raw.githubusercontent.com/th3nk/NeyzkFile/master/GetVersion.txt') or 0
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : نيزك 🍃",url="t.me/th3nk"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : نيزك](t.me/th3nk)',nil,inline,msg.id_)
return false
end
...
return [[
👨‍✈️┊مرحبا بک عزيزي 🙇‍♂
🔘┊في معلومات سورس النيزک !
ـ••┉┉┉┉┉┉┉┉┉┉┉┉┉••
📡┊[قناة سورس النيزک](t.me/TH3NK) ؛
🛰┊[قناة الملفات والبوتات](t.me/thtss) ؛
🔆┊[ڱروب فريق التطوير](t.me/dTH3SS) ؛

ـ┄─━━━━━━━─┄
📟┊[مصنع السورس php](t.me/mgrooupbot) ؛
📝┊[بوت زخرفة الاسماء](t.me/TH3NKbot) ؛
🔰┊[بوت دعم القنوات](t.me/Gro8bot) ؛
📮┊[تواصل السورس](t.me/TH3NEKbot) ؛
👨🏻‍✈️┊[المطور الرسمي](t.me/th3ss) ؛
ـ┄─━━━━━━━─┄
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/th3nk/NeyzkFile/master/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/th3nk/NeyzkFile/master/plugins/"..FileName)
if res == 200 then
...
redis:setex(neyzk..":propin"..data.chat_id_,100,data.content_.text_)
end)
end
